...
public:
	...
	*/
    ...
    // Set the color of the single line border
    virtual void SetSingleLineBorderColor(wxColor borderColor);
...
protected:
    ...
    // Color of the single line border
    wxColor m_SingleLineBorderColour = wxColor(255,255,255);
...
public:
    /* Additional width and height that will be added. If any of these == 0, in default size they'll be displayed*/
    int _TabAdditionalWidth = 35;
    int _TabAdditionalHeight = 35;
};
